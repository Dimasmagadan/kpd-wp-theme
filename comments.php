...
// Do not delete these lines
	...
	if ( post_password_required() ) { ?>
		<p class="nocomments">Эта запись закрыта паролем.</p>
	<?php
		return;
	}
?>
...
<section id="respond">
	...
	<h3><?php comment_form_title( 'Ответить', 'Ответить на %s' ); ?></h3>
	...
	<p>Нужно <a href="<?php echo wp_login_url( get_permalink() ); ?>">войти</a> для добавления комментария</p>
	<?php else : ?>
